...
export default function ChatPage() {
    ...
    // Determine mobile visibility
    const showSidebar = isMobileSidebarOpen || !activeConversationId;
    const showChatArea = !isMobileSidebarOpen || activeConversationId;
    ...
    return (
        <div className="flex flex-col h-[100dvh] bg-gradient-to-br from-[#1e293b] to-[#0f172a] font-sans overflow-hidden">
            ...
            <div className="flex flex-1 pt-20 overflow-hidden">
                {/* Sidebar
                    - Mobile: full width, toggles with chat area
                    - Tablet (md): fixed width 320px 
                    - Desktop (lg): 360px
                    - Large (xl): 400px
                */}
                <div
                    className={`
                        ...
                        w-full
                        md:!flex md:w-80 lg:w-[360px] xl:w-[400px]
                ...
                {/* Chat Area
                    - Mobile: full width, toggles with sidebar
                    - Tablet+: always visible, fills remaining space
                */}
                <div
                    className={`
