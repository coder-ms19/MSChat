...
export default function ChatConversationPage() {
    ...
    if (!user || isLoading) {
        return (
            <div className="flex flex-col h-[100dvh] bg-gradient-to-br from-[#1e293b] to-[#0f172a] font-sans overflow-hidden">
                <div className="w-full flex flex-col flex-1 min-w-0 bg-gradient-to-br from-[#0f172a] to-[#0a0a0f]">
                    <ChatHeaderSkeleton />
                    <div className="flex-1 overflow-y-auto px-3 sm:px-4 md:px-5 lg:px-6 py-3 md:py-4">
                        {[...Array(5)].map((_, i) => (
    ...
    if (!conversation) {
        return (
            <div className="flex h-[100dvh] bg-gradient-to-br from-[#1e293b] to-[#0f172a] font-sans overflow-hidden items-center justify-center p-4">
                <div className="text-center p-6 sm:p-8 max-w-sm w-full">
                    <div className="w-16 h-16 sm:w-20 sm:h-20 mx-auto mb-3 sm:mb-4 rounded-full bg-red-500/20 flex items-center justify-center">
                    ...
                    <h2 className="text-lg sm:text-xl font-bold text-white mb-2">Conversation Not Found</h2>
                    <p className="text-sm sm:text-base text-slate-400 mb-4 sm:mb-6">This conversation doesn't exist or you don't have access to it.</p>
                    <button
                        onClick={() => navigate('/conversations')}
                        className="px-5 py-2 sm:px-6 sm:py-2.5 rounded-xl bg-gradient-to-r from-blue-600 to-purple-600 text-white text-sm sm:text-base font-medium hover:from-blue-700 hover:to-purple-700 transition-all shadow-lg shadow-blue-500/25 active:scale-95"
                    >
