...
export const Sidebar: React.FC<SidebarProps> = ({
    ...
    return (
        <div className="w-full bg-[#111827] border-r border-white/8 flex flex-col h-full shadow-2xl z-20 overflow-hidden">
            {/* Header - Compact & Clean */}
            <div className="px-3 sm:px-4 pt-3 sm:pt-4 pb-2 flex-shrink-0 space-y-2.5 sm:space-y-3">
                <div className="flex items-center justify-between">
                    <h1 className="font-bold text-white text-base sm:text-lg tracking-tight">Messages</h1>
                    <button
                        onClick={onCreateGroup}
                        className="w-8 h-8 rounded-full bg-gradient-to-br from-blue-600 to-purple-600 flex items-center justify-center text-white shadow-lg shadow-blue-500/20 hover:scale-105 active:scale-95 transition-all touch-manipulation"
                        title="Create Group"
                    >
                ...
                <div className="relative group">
                    <div className="relative bg-[#0f172a]/50 border border-white/10 rounded-xl flex items-center transition-all focus-within:border-blue-500/50 focus-within:bg-[#0f172a]">
                        ...
                        <input
                            ...
                            className="w-full bg-transparent text-white text-sm sm:text-base py-2 px-2.5 rounded-xl focus:outline-none placeholder-slate-600"
                        />
                        {searchQuery && (
                            <button
            ...
            <div className="flex-1 overflow-hidden relative">
                <AnimatePresence mode="wait">
                    {activeTab === 'chats' ? (
                        ...
                        >
                            <div className="flex-1 overflow-y-auto px-1.5 sm:px-2 py-1.5 sm:py-2 space-y-0.5 sm:space-y-1 scrollbar-thin scrollbar-thumb-slate-600 scrollbar-track-transparent">
                                {isLoading ? (
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    ...
                                                    <p className="text-[12px] sm:text-[13px] text-slate-400 truncate max-w-[200px] sm:max-w-[180px] md:max-w-[180px] lg:max-w-[220px]">
