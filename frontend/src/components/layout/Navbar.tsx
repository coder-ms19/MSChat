...
import { Layers, MessageCircle, LogOut, UserPlus, Menu, X, Maximize, Minimize, Video, Shield } from 'lucide-react';
                ...
                <div className="flex items-center gap-4">
                    ...
                    {isLoggedIn ? (
                        <>
                            ...
                            {user?.role === 'ADMIN' && (
                                <Link to="/admin">
                                    <Button className="hidden md:flex bg-purple-500/10 text-purple-400 border border-purple-500/20 hover:bg-purple-500/20 hover:border-purple-500/30 backdrop-blur-md gap-2 rounded-xl transition-all shadow-[0_0_15px_rgba(168,85,247,0.15)] hover:shadow-[0_0_20px_rgba(168,85,247,0.3)] hover:scale-105">
                                    ...
                                    {isProfileMenuOpen && (
                                        ...
                                        >
                                            ...
                                            <div className="p-2">
                                                ...
                                                {user?.role === 'ADMIN' && (
                                                    <Link to="/admin">
                                                        <button className="w-full flex items-center gap-3 px-3 py-2 text-sm text-slate-300 hover:text-white hover:bg-white/5 rounded-xl transition-colors text-left mt-1">
                                ...
                                {isLoggedIn ? (
                                    <>
                                        ...
                                        <div className="grid grid-cols-2 gap-3">
                                            ...
                                            {user?.role === 'ADMIN' && (
                                                <Link to="/admin" onClick={() => setIsMobileMenuOpen(false)} className="col-span-2">
                                                    <Button className="w-full justify-start bg-purple-500/10 text-purple-400 border border-purple-500/20 hover:bg-purple-500/20 gap-2 rounded-xl h-12">
                                                        <Shield className="w-4 h-4" />
                                                        Admin Dashboard
                                                    </Button>
                                                </Link>
